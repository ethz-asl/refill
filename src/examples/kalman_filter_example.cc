...
int main(int argc, char **argv) {
  ...
  // t = 1.0
  double dt = 1.0;
  Eigen::Vector3d measurement_1 = Eigen::Vector3d::Constant(1.5);
  ...
  ekf.update(measurement_model, measurement_1);
  ...
  // t = 1.5
  dt = 0.5;
  Eigen::Vector3d measurement_2 = Eigen::Vector3d::Constant(1.5);
  ...
  ekf.predict(system_model);
  // update the kf with the measurement and the measurement model
  ekf.update(measurement_model, measurement_2);
