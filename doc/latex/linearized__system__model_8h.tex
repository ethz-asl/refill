...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{linearized__system__model_8h__incl}
\end{center}
\end{figure}
...
\begin{DoxyCompactList}\small\item\em Class that implements a linearized system model. \end{DoxyCompactList}\end{DoxyCompactItemize}
