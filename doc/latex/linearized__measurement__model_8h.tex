...
\begin{center}
\leavevmode
\includegraphics[width=316pt]{linearized__measurement__model_8h__incl}
\end{center}
\end{figure}
...
\begin{DoxyCompactList}\small\item\em Class that implements a linearized measurement model. \end{DoxyCompactList}\end{DoxyCompactItemize}
