...
\begin{center}
\leavevmode
\includegraphics[width=298pt]{measurement__model__base_8h__incl}
\end{center}
\end{figure}
...
\begin{DoxyCompactList}\small\item\em Interface for measurement models. \end{DoxyCompactList}\end{DoxyCompactItemize}
